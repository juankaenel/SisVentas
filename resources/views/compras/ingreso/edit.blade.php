...
<!--No uso porque no puedo editar un ingreso-->
@section('contenido')
   <div class="row">
        <div class="col-lg-6 col-md-6  col-sm-6 col-xs-12">
            <h3>Editar Ingreso {{$ing->nombre}}</h3>
            ...
            <form action="{{ route('ingreso.update', $ing->idingreso) }}" method="POST">
                @method('PUT')
                @csrf

            <div class="form-group">
                <label for="nombre">Nombre</label>
                <input type="text" name="nombre" class="form-control" value="{{$ingreso->nombre}}" placeholder="Nombre..">
            </div>
