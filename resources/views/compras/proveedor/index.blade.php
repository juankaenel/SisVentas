...
@section('contenido')
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            ...
            <a href="../../compras/proveedor/create" class="btn btn-success">Nuevo Proveedor</a>
            <hr>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <td>{{$per->direccion}}</td>
                        <td>
                            <a href="{{route('proveedor.edit', $per->idpersona)}}" class="btn btn-warning btn-sm">Editar</a>
