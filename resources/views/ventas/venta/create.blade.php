...
@section('contenido')
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <select name="idcliente" id="idcliente" class="form-control select-picker"
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="pidarticulo" id="pidarticulo" class="form-control select-picker"
                                        ...
                                        @foreach($articulos as $articulo)
                                            <!--enviamos varios campos separados por medio de un _ . Con js lo que haremos es seperar esos _ asi poder utilizarlos independientemente -->
                            ...
                            <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" disabled id="pstock" name="pstock" class="form-control"
                                           placeholder="Stock">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                ...
                                <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                                    ...
                                    <!--creamos un input para poder mandar los datos-->
                                    </tfoot>
                                    <tbody>
    ...
    @push('scripts')
        <script>
            ...
            $("#pidarticulo").change(mostrarValores); //cada vez q yo seleccione un articulo va a llamar a mostrar valores

            function mostrarValores() {
            datosArticulos = document.getElementById('pidarticulo').value.split('_'); //hacemos la separacion de valores con un split, y obtenemos cada posicion
            /*$(#pprecio_venta).val(datosArticulos[0]);       la posicion 0 es la que toma el pidarticulo*/
            ...
            function agregar() {
                ...
                if (idarticulo != "" && cantidad != "" && cantidad > 0 && descuento != "" && precio_venta != "") {
                    ...
                    /*validamos el stock. Si es mayor q la cantidad q se está vendiendo, realizamos la venta*/
                    if(stock >= cantidad){
                        ...
                        let fila = '<tr class="selected" id="fila'+cont+'"> <td> <button type="button" class="btn btn-warning" onclick="eliminar('+cont+'); ">X</button> </td> <td><input type="hidden" name="idarticulo[]" value="' + idarticulo + '">' + articulo + '</td> <td><input type="text" name="cantidad[]" value="' + cantidad + '"></td> <td><input type="number" name="precio_venta[]" value="' + precio_venta + '"></td> <td><input type="number" name="descuento[]" value="' + descuento + '"></td> <td>' + subtotal[cont] + '</td> </tr>';
